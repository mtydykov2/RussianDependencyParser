...
# http://ufal.mff.cuni.cz/tred is rewritten during release to actual URL of TrEd webpage (build-dep-package.sh)
tred_url="http://ufal.mff.cuni.cz/tred/tred-current.tar.gz"
tred_dep="http://ufal.mff.cuni.cz/tred/tred-dep-unix.tar.gz"
